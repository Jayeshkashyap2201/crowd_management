...
class WashroomsEnglish extends StatefulWidget {
  ...
  @override
  State<WashroomsEnglish> createState() => _WashroomsEnglishState();
}

class _WashroomsEnglishState extends State<WashroomsEnglish> {
  bool show =false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Searching for Washroom?",style: TextStyle(fontSize: size.width*0.05,color: Colors.white),),
        backgroundColor: Colors.purple,
        centerTitle: true,
      ),
      body: Hero(
        tag: "moved_from_homepage1",
                  ...
                  Positioned(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if(show)
                          Text("Indicates the washroom in the Map", style: TextStyle(color: Colors.white, fontSize: size.width * 0.04,)),
                      ],
                    ),
                  ),
                  Image(
